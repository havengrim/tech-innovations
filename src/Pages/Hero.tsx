    ...
    <div className="relative w-full h-[60vh] md:h-[60vh] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center z-20 sm:max-w-4xl sm:mx-auto">
        <h1 className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-6xl font-bold text-center font-sans">
          Innovative Insights with Timeless Wisdom
        </h1>
        <p className="text-white text-lg sm:text-xl md:text-lg font-light text-center mt-4 max-w-lg sm:max-w-2xl px-4">
        Stay ahead in the tech landscape with Tech Innovations Daily. <br />Ignite your passion for technology today!
        </p>
        <div className="flex flex-col sm:flex-row gap-3 mt-4">
        <Button className="rounded-full bg-[#5271ff] p-4 sm:p-8 text-base sm:text-lg flex items-center justify-center">
      ...
      >
        ...
        <SwiperSlide
          className="bg-cover bg-center h-full"
          style={{
            backgroundImage: `url(${images.slider1})`, // Use image from your assets
            height: '100%',
          }}
        ></SwiperSlide>
        <SwiperSlide
          className="bg-cover bg-center h-full"
          style={{
            backgroundImage: `url(${images.slider3})`, // Use image from your assets
            height: '100%',
          }}
        ></SwiperSlide>
        <SwiperSlide
